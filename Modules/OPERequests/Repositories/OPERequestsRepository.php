...
namespace Modules\OPERequests\Repositories;
...
class OPERequestsRepository extends BaseRepository
{
    ...
    public function getByUnitHeadId($id)
    {
        ...
        return OPERequests::where('unit_head_id', $id)->paginate(10);
    }

    public function getByBranchId($id)
    {
        //return DB::table('dta_requests')->where('unit_head_id', $id)->paginate(10);
        return OPERequests::where('branch_id', $id)->paginate(10);
    }
