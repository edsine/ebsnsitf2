...
<div class="menu-item pt-5">
    ...
    <div class="menu-content">
        <span class="menu-heading fw-bold text-uppercase fs-7">Shared</span>
    </div>
    <!--end:Menu content-->
</div>
<!--end:Menu item-->
...
<div class="menu-item">
    <!--begin:Menu link-->
    <a href="{{ route('branches.index') }}" class="menu-link {{ Request::is('branches*') ? 'active' : '' }}">
...
<div class="menu-item">
    <!--begin:Menu link-->
    <a href="{{ route('departments.index') }}" class="menu-link {{ Request::is('departments*') ? 'active' : '' }}">
        <span class="menu-icon">
            <!--begin::Svg Icon | path: icons/duotune/abstract/abs014.svg-->
            <span class="svg-icon svg-icon-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
