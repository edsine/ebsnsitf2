            ...
            <div class="col-xl-4">
                ...
                <a href="#" class="card bg-info hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bold fs-2 mb-2 mt-5">{{$registered_employees}}</div>
                        <div class="fw-semibold text-white">DEATHS NOTIFICATION</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <h3 class="fw-bold">Compliances statistics</h3>
                                <ul class="list-group">
    <li class="list-group-item list-group-item-primary">Pending</li>
    <li class="list-group-item list-group-item-success">Failed</li>
    <li class="list-group-item list-group-item-danger">Approved</li>
  </ul>
										...
										<div class="card card-flush h-xl-100">
											...
											<div class="card-header pt-7">
												...
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label fw-bolder text-gray-800">Reporting and Analytics</span>
        ...
        60%
              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  ...
                  <div class="progress">
      <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;">
        60%
      </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    ...
                                                    <span
                                                        class="text-muted fw-semibold text-muted d-block fs-7">Pending</span>
                                                </td>
                                                <td>
                                                    <a href="#"
