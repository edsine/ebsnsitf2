					...
					<div class="card card-flush h-100 mb-5 mb-xl-10">
						...
						<div class="card-header pt-7">
							...
							<h3 class="card-title align-items-start flex-column">
								<span class="card-label fw-bold text-dark">Expense Categories Distribution</span>
									...
									<div class="m-0">
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex align-items-center me-5">
												...
												<div class="me-5">
													<!--begin::Title-->
													<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Human Resourse</a>
													<!--end::Title-->
													<!--begin::Desc-->
													<span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Compensation and Benefits</span>
													<!--end::Desc-->
												</div>
												<!--end::Content-->
											</div>
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex align-items-center me-5">
												...
												<div class="me-5">
													<!--begin::Title-->
													<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Distribution</a>
													<!--end::Title-->
													<!--begin::Desc-->
													<span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Frequency Metrics</span>
													<!--end::Desc-->
												</div>
												<!--end::Content-->
											</div>
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex align-items-center me-5">
												...
												<div class="me-5">
													<!--begin::Title-->
													<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Marketing</a>
													<!--end::Title-->
													<!--begin::Desc-->
													<span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Quaterly Report</span>
													<!--end::Desc-->
												</div>
												<!--end::Content-->
											</div>
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex align-items-center me-5">
												...
												<div class="me-5">
													<!--begin::Title-->
													<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Research</a>
													<!--end::Title-->
													<!--begin::Desc-->
													<span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Quaterly reports</span>
													<!--end::Desc-->
												</div>
												<!--end::Content-->
											</div>
				...
				<div class="col-xl-8 mb-5 mb-xl-10">
					...
					<div class="card card-flush h-xl-50 mb-xl-10">
						...
						<div class="card-header pt-7">
							<!--begin::Title-->
							<h3 class="card-title align-items-start flex-column">
								<span class="card-label fw-bold text-gray-800">Expense Categories Distribution</span>
					...
					<div class="card card-flush overflow-hidden h-md-100">
						...
						<div class="card-header py-5">
							...
							<h3 class="card-title align-items-start flex-column">
								...
								<span class="text-gray-400 mt-1 fw-semibold fs-6">Reports by state and gender</span>
							</h3>
							<!--end::Title-->							
						</div>
						<!--end::Header-->
